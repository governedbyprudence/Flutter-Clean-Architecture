...
import 'package:fact_app/features/number_trivia/domain/usecases/get_concrete_number_trivia.dart';
...
void main(){
  ...
  final tNumber = 1;
  final tNumberTrivia = NumberTrivia(text: "Testing", number: tNumber);
  test(
